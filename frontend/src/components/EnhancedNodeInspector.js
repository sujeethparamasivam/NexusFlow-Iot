...
export function EnhancedNodeInspector({ node, onUpdate, onDelete }) {
    ...
    return (_jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-8 shadow-sm", children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("h3", { className: "font-bold text-2xl flex items-center gap-3", children: [_jsx(Settings, { className: "w-6 h-6 text-blue-600" }), "Node Inspector"] }), _jsx("span", { className: "bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium capitalize", children: node.type })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "ID" }), _jsx("input", { type: "text", value: node.id, disabled: true, className: "w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-sm font-mono" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Label" }), _jsx("input", { type: "text", defaultValue: node.data?.label, onChange: (e) => {
                                    if (onUpdate) {
                                        onUpdate({
                                            ...node,
